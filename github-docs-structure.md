...
> **Version:** 1.8 (v1.2-lineage: +AUTHORITY.md +INDEX.md +contracts/ +knowledge/ +traceability/ وتصحيح موطن ترتيب السلطة) (v1.0-baseline: ملفات ADR الفردية المزروعة تحت decisions/adr/؛ سبقه FIX-9 v0.8) · **Status:** Current / Accepted · **Date:** 2026-07-10  
...
local-rag-enterprise-specs/                                 # حزمة الوثائق الرسمية (الاسم الفعلي للمستودع)
  README.md                                                 # نقطة الدخول + ترتيب القراءة + إحالة ترتيب السلطة إلى AUTHORITY.md
  AUTHORITY.md                                              # النص الكنسي الوحيد لترتيب السلطة (13 مرتبة + خريطة الأرقام)
  INDEX.md                                                  # الفهرس البشري الحاكم للمواضع والحالات (OD-IDX-1)
  ...
  PROJECT_EVOLUTION.md                                      # فهرس سردي لتطور المشروع (يشير للمصادر — ليس مصدر حقيقة ثانياً) (Δ 2026-07-11)
  FLUTTER_ROLLBACK_AND_OPENWEBUI_BRIDGE_HANDOFF.md          # تقرير دفعة تنحية Flutter وجسر Open WebUI (Δ 2026-07-11)
  ...
  decisions/
    ...
    DEFERRED_IMPLEMENTATION.md                              # سجل المؤجلات الرسمي — Tier-0، لا إضافة إلا بقرار SA (Δ إغلاق المواصفات)
    license-review.md                                       # سجل مراجعة التراخيص وبوابات الاعتماد
    adr/
      README.md                                             # السجل الكنسي للـ ADRs (v1.2 — سياسة D15)
      ADR-XXXX-*.md                                         # ملفات فردية مزروعة (v1.0-baseline): 0004 · 0017–0022 (مزروعة) + 0023–0028 (جديدة) + 0029–0030 (Δ 2026-07-11: العميل القابل للاستبدال · Open WebUI مؤقتة)؛ البقية تُزرع عند الحاجة

  contracts/                                                # طبقة العقود — المصدر الوحيد للعقود (ADR-0035)
    NAMING_AND_CONTRACTS_STANDARD.md
    identity/
    screens/
    enums/

  knowledge/                                                # معجم الأعمال وقاعدة معرفة النظام
    BUSINESS_GLOSSARY.md

  traceability/                                             # مصفوفة التتبع (أصل G1)
