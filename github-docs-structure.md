...
> **Version:** 1.6 (FIX-9 v0.8: إدراج ملفات ui لحزم v0.5/v0.6/v0.7.1 + تصحيح اسم جذر الشجرة + تحديث نطاق handoff + ملفات دفعة v0.8) · **Status:** Current / Accepted · **Date:** 2026-07-10  
