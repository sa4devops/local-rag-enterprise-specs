...
| `scope_inheritance` | `SELF_ONLY` (افتراضي) · `SELF_AND_DESCENDANTS` · `EXPLICIT_ORG_UNITS` | قرار مالك (R1) | **Accepted — قرار مالك (R1 2026-07-21)** | اختيار النطاق وتغييره يُسجَّلان بالتدقيق (ADR-0037) · ينطبق على المنح المنطاقة فقط؛ الدور الشامل خارج هذا التعداد (ADR-0038 — Proposed — يُقبل بتوقيع/دمج SA في بوابة R1-C). لا تُضاف قيمة تعني «كل الوحدات». |
