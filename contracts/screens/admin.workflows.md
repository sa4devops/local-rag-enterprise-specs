...
حوكمة التعريفات · **البيانات:** ‏workflow_definitions ‏(تشمل `owning_org_unit_id` — الوحدة المالكة، ‏ADR-0037) · **الأفعال:** ‏`wf.define`/`wf.validate`/`wf.submit` · **الصلاحية:** ‏`admin.workflows.manage`؛ **الاعتماد لـ`wf.approve` بمعتمِد غير المعرِّف (SoD)** · **التدقيق:** ‏`WORKFLOW_DEFINED`/`WORKFLOW_VALIDATED`.
