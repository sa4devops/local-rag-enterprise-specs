...
> **Version:** 1.1 — (Δ 2026-08-08 R3 — `OD-R3-SCOPE-2`: **تصويب العدد 52 ⇒ 51** في §ب (العدد القانوني المثبَّت لشاشات الجرد الحالية) · **تثبيت معرّفات الجرد الحالية قانونيةً** · **+§ج-5 إلزام التغطية**: بطاقة سلوك وعقد `Candidate` واحد على الأقل لكل شاشة حالية — **بلا شاشة جديدة ولا بطاقة ولا عقد أُلّف في هذه الدفعة**) · الأصل 1.0 — Accepted — G1-B 2026-07-20 (merge dd098dff9bed7a1f267ec5552b0e3366e368883d · tag v1.2-governance-baseline) · **Date:** 2026-07-19 · **الموضع:** `ui/UI_SCREEN_GOVERNANCE_STANDARD.md`
...
| Archetype | التعريف السطري | أمثلة (الإسناد الكامل للـ51 شاشة في عمود `archetype` بالجرد v1.4 — لا يُكرر هنا؛ **تصويب `OD-R3-SCOPE-2`: العدد القانوني 51 لا 52**) |
|---|---|---|
...
5. **إلزام التغطية (‏Δ 2026-08-08 · `OD-R3-SCOPE-2`):** **العدد القانوني للشاشات الحالية 51** — ومعرّفاتها القانونية هي **`screen_id` الحالية في `ui/UI_SCREEN_INVENTORY.md` (جدولا A/B — v1.4)** حصراً. و**لكل شاشة حالية**: صفٌّ مطابق في الجدول A · صفٌّ مطابق في الجدول B · **بطاقة سلوك** في `ui/UI_SCREEN_BEHAVIOR_CARDS.md` · **عقد شاشة `Candidate` واحد على الأقل** في `contracts/screens/`. **واستيفاء هذه التغطية شرطُ إغلاق `R3` التوثيقي** (‏`OD-R3-SCOPE-2` §(ط)) — **ولا يُنشئ هذا البند شاشةً ولا بطاقةً ولا عقداً بنفسه**، وإنشاء أي شاشة جديدة يبقى بقاعدة البند 2 أعلاه.
