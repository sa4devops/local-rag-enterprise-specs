...
| admin.org | الشجرة والعضوية | شجرة **مرنة العمق** (`parent_unit_id` · `unit_type`: department/section/unit — FR-1.Org-Ext Δ v0.8) · العضوية **على أي مستوى** · توريث النطاق نزولاً | org.unit_create/move · membership.change | admin.org.manage | ORG_CHANGED | G6 |
...
| **OD-BLD-1** | **وضع محادثي لباني الشاشات (محادثة/تقليدي/مدمج)** | **مقفل بقرار SA (2026-07-10 — دفعة v0.8)** — التفصيل المعياري في ملاحظة §4-C أعلاه؛ الخط المحكوم draft→migration→checks→approval→apply بلا تغيير، والـ LLM يكتب metadata فقط |
