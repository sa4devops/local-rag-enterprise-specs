...
> **Version:** 1.3 (v1.0-baseline: +سطر التجميد عند الوسم + مواءمة ADR-0019/ADR-0026؛ سبقه v0.8: تصحيح مرجعَي الإصدار v2.0 → v2.1) · **Status:** Current / Accepted · **Date:** 2026-07-10
