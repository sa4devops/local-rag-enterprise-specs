...
| **ما يلزم للحكم النهائي** | فحص الترتيب السلطوي والوجهة المقرَّرة في المستودع الكامل. **Governance وTests ليسا بديلين:** الأول يقنِّن المعيار والثاني يتحقق منه — و`ui/UI_SCREEN_GOVERNANCE_STANDARD.md:68` يوجّه a11y **كاملةً** إلى `DESIGN_SYSTEM §§9–11` «بصيغة قابلة للاختبار» ولا يعرض خياراً بين الاثنين. الدليل الحالي **يرجّح** أن المعايير السبعة تُقنَّن في `DESIGN_SYSTEM`/Governance بصيغة قابلة للاختبار وأن تستمد Tests فحوصها منها — أي أنها **دلتا تقنين في R3 لا قرار مالك**. **لا يُرفع الأمر إلى قرار مالك** إلا إذا كشف B2 أو فحص السلطة عن **سلطتين حاكمتين أو نطاقين متعارضين فعلياً**. لا يُحسم قبل اكتمال B2 وحساب §13b |
