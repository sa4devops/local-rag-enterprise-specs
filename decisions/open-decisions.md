...
|---|---|---|---|
| مبدأ العميل القابل للاستبدال | decisions/adr/ADR-0029-replaceable-client-principle.md | **مقفل** (ترقيته للدستور مشروطة باختبار الاستبدال) | كل عميل يستهلك العقود فقط؛ لا حقيقة/صلاحيات/قواعد عمل/DB في أي عميل؛ الخادم يعيد التحقق ويملك القرار |
