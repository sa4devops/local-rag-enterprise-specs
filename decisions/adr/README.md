...
| ADR-0031 | عميل الواجهة الأساسي: Next.js client-only عبر قناة Rocket المحكومة (الحراس الأربعة؛ بوابات `pnpm` الموحدة؛ استبدال React/Vite مصغر مؤجل — م23) | **Accepted** — 2026-07-20 | 2026-07-19 · [ADR-0031-primary-ui-client-nextjs-client-only-rocket.md](ADR-0031-primary-ui-client-nextjs-client-only-rocket.md) · يخلف ADR-0017 في نطاق اختيار الإطار |
| ADR-0032 | تخزين السجلات الديناميكية الهجين: أعمدة نواة + JSONB + ترويج مقنن عبر م10؛ ‏internal_id = ‏UUIDv7 (التوليد في التطبيق أو DB — غير مربوط بدالة إصدار PG) | **Accepted** — 2026-07-20 | 2026-07-19 · [ADR-0032-dynamic-records-hybrid-storage-uuidv7.md](ADR-0032-dynamic-records-hybrid-storage-uuidv7.md) |
| ADR-0033 | مستويات الأتمتة L0–L3 وسياسة Git/الدمج/الوسوم: مسارات محمية · قناة `rocket-update` · ‏revert-PR · ‏FP-0001/0002 على L1 ثم L2 افتراضي للمنخفض | **Accepted** — 2026-07-20 | 2026-07-19 · [ADR-0033-automation-levels-git-merge-policy.md](ADR-0033-automation-levels-git-merge-policy.md) |
