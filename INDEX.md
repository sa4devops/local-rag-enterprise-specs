...
> **Version:** 1.0 — Accepted — G1-B 2026-07-20 (merge dd098dff9bed7a1f267ec5552b0e3366e368883d · tag v1.2-governance-baseline) · (Δ 2026-07-20 G1-C: تطبيع صفوف الحالة بعد تدقيق G1-B — تصويب صفوف ADR-0017/0031..0036 + إزالة انتساب (G1) الكاذب من 25 صفاً تاريخياً) · (Δ 2026-07-22 R1-C: +صف ADR-0038 + تحديث الإجمالي) · (Δ 2026-07-25 P3: +9 صفوف تغطية لأرشيف RAR غير الحاكم `references/analysis-inputs/rar-2026-07/` — بتجاوز مالك محدود ومؤرَّخ لـEC-3؛ الإجمالي 131 + الفهرس) · (Δ 2026-07-30 P3/Phase Exit Review: +صف `traceability/rar-reconciliation/P3-CLOSURE-INVENTORY.md` + تحديث الإجمالي؛ 154 → 155 + الفهرس) · **Date:** 2026-07-19 · **الموضع:** `/INDEX.md`
...
| `decisions` | `decisions/open-decisions.md` | 2.5 — (Δ 2026-07-29 P3/R2: +فهرس قرارات المالك OD-RAR-01..09 | Current / Accepted · Δ R1-B: +OD-ADM-1 · ملاحظة OD-ORG-1 · Δ P3/R2: +OD-RAR-01..09 مقفلة | طبقة القرارات — SA | ‏Tier-0 لكل وكيل |
