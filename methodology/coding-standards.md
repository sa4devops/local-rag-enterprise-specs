...
> **Version:** 1.1 — Final (D1–D9 مدمجة: الستاك محسوم + سياسة Reference-aware + قواعد Observability) · **Status:** Current / Accepted · **Date:** 2026-07-04
...
**لا يُسمح له أن:** ينسخ ملفات كاملة · ينسخ مقتطفات طويلة (**تجاوز ~10 أسطر ⇒ يتطلب صف license-review وامتثالاً صريحاً**) · يغيّر أسماء المتغيّرات فقط ويعتبره كوداً جديداً (**ويشمل ذلك الاستنساخ الحرفي «من ذاكرة النموذج»**) · يزيل notices/attribution يفرضها الترخيص · يُدخل كود AGPL/SSPL/commercial/copyleft أو أي كود حسّاس دون **Legal Review** · يخالف تراخيص المراجع · يربط النظام بمشروع خارجي دون قرار معماري (ADR).

**الخطوات الإلزامية عند استخدام مرجع OSS:** (1) تحديد المشروع وسبب استخدامه → (2) مراجعة ترخيصه → (3) كتابة summary لما تعلّمه (لا نسخ) → (4) implementation خاص بنا وفق المواصفات → (5) ذكر المرجع في handoff → (6) أي استخدام مباشر لكود/مكتبة ⇒ عبر License Review → (7) موافقة صريحة حسب الترخيص والسياسة قبل الدمج.
