...
- **actual PR number:** **يُلتقط من GitHub نفسه بعد إنشاء الـPR** ويُثبَّت في الـcommit الثاني المخطَّط (انظر «نموذج الدفعة» أدناه) — فرقم الـPR **لا يُعرف قبل إنشائه ولا يُقدَّر**.
