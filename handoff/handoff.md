...
- next step: **قرار مالك في هذا الـPR** (‏دمج أو رفض) — **والنفاذ يبدأ عند الدمج فقط**. ودمجُه جائزٌ بـ**الاستثناء الانتقالي** بيد **وكيل دمج مستقل لم يكتب هذا الـPR ولم يدفع إلى فرعه**، بعد **مراجعة مستقلة** و**بوابات** و**تثبيت Head SHA**. وبعده وبأمر مالك مستقل: **جلسة Merge Agent مستقلة لـPR #14** تتحقق من بقاء الرأس `52d88d0e…` ومن **مراجعة مستقلة** (‏**غير مستوفاة حتى تاريخه**) ومن الفحوص الاثني عشر، **ثم تُحسم مسألة التعارض التسلسلي بقرار مالك**. **ولا شيء من ذلك مأذون به في هذه الجولة.**
